        ...
        for product in state.order_depths:
            ...
            if product == "AMETHYSTS":
                ...
                if idx == 0:
                    ...
                    self.attributes['orchids_ob_1'] = [0] * 10
                    self.attributes['orchids_ob_2'] = [0] * 10
                    self.attributes['orchids_ob_3'] = [0] * 10
                ...
                active_buy_price_3 = int(ext_sell_price) - 2
                active_buy_price_2 = int(ext_sell_price) - 1
                active_buy_price_1 = int(ext_sell_price)
                active_sell_price_3 = int(ext_buy_price) + 3
                active_sell_price_2 = int(ext_buy_price) + 2
                ...
                if idx >= 30 and idx % 10 == 0:
                    ...
                    if total > 0:
                        ...
                        print(forecast_sell_profit_1, forecast_sell_profit_2, forecast_sell_profit_3)
                ...
                print("@@", active_sell_price_1, active_sell_price_2, active_sell_price_3, sell_capacity_1, sell_capacity_2, sell_capacity_3)
                ...
                result["GIFT_BASKET"] = [Order("GIFT_BASKET", sorted_buy_orders_basket[0][0], basket_buy_capacity),
                                         Order("GIFT_BASKET", sorted_sell_orders_basket[0][0], -basket_sell_capacity)]
